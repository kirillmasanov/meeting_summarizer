...
2. Выберите тип промпта (Встреча с клиентом, Обучающий вебинар, Собеседование, Стендап, Встреча по продажам); при необходимости отредактируйте текст в «Настройки промпта»
...
- **Встреча по продажам** (`prompts/sales.txt`) — потребности клиента, предложение, возражения, следующие шаги
