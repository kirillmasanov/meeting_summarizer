...
2. Выберите тип промпта кнопкой (Встреча с клиентом, Обучающий вебинар, Собеседование, Стендап, Встреча по продажам). При необходимости отредактируйте текст в блоке «Настройки промпта»
...
- **Встреча по продажам** (`prompts/sales.txt`)
